...
\begin{lstlisting}[caption={Representing aggregations in DPDT},label={lst:DPDT_aggregations}]
...
\begin{lstlisting}[caption={PureFn expression constructor}, label={lst:purefn}]
PureFn : (a -> b) -> Expr s a -> Expr s b
\end{lstlisting}
