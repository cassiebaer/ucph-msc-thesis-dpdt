...
It differs from partition-based anonymization methods like \textit{k-anonymization} in that auxiliary data about the individuals does not pose a threat to the privacy guarantees.

PINQ is a framework for C\# implementing differential privacy on top of a popular integrated query language, LINQ.
PINQ dynamically verifies that queries abide to differential privacy constraint, and discard queries if they don't.
...
While PINQ verifies privacy constraints dynamically, our language does it statically.
