...
% TODO 2 : add a figure of Laplace PDF and refer to it from here

\begin{table}[h!]
  \caption{Expected and actual results of testCountAlices}
...
{\color{red}
  ...
  We will implement a better PRNG ASAP!
  % TODO 1 : implement a better PRNG
}

Of course, we shouldn't be allowed to run that query 1,000 times!
The privacy cost of generating that table would have been 1,000.
In fact, it is more likely that an analyst might be able to run the query two or three times.
Listing % TODO
