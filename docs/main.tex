...
% TODO 1 : improve introduction by giving it structure
% TODO 1 : merge motivation from diff.priv. into intro.
% TODO 1 : use \chapter
% TODO 1 : improve captions for all figures
% TODO 1 : grep for all uses of very/easy/easily
...
It differs from partition-based anonymization methods like \textit{k-anonymization} in that auxiliary data about the individuals does not pose a threat to their privacy guarantees.

PINQ is a framework for C\# implementing differential privacy on top of a popular integrated query language, LINQ.
...
We have implemented a prototype of a differentially private query language embedded in Idris.
Idris is a general purpose, pure functional programming language with dependent types.
Our query language is called DPDT, which is an abbreviation for Differential Privacy and Dependent Types.
...
% TODO 5 : add more contributions if there are any. noisyAverage improvement? improved PRNG? contributions to idris-dev
...
% TODO 5 : talk about the parallel to cryptography guarantees
...
\subsection{Monadic sequencing and do-notation}
...
In fact, Idris makes it very easy.
...
% TODO 5 : implement a better PRNG
}
...
There are no limits on constructing independent, differentially-private queries, but dynamically terminating algorithms cannot easily be expressed because privacy constraints cannot be verified at compile-time.
Despite this limitation, we believe that dependent types lend themselves very well to representing differential privacy metrics and constraints.
