...
There is only one data constructor which serves simply to wrap a \texttt{Query}, which was defined in Chapter~\ref{sec:RADT}.
...
By unwrapping and rewrapping the \texttt{Query} trees from Chapter~\ref{sec:RADT} in our new type, we are now able to build query trees that carry privacy metrics in the type.
