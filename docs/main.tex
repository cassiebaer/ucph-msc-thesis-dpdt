...
Our approach is based on an example from \cite{OurySwierstra08PowerOfPi} presenting a database schema representation in another dependently typed language, Agda\footnote{https://github.com/agda/agda}.
