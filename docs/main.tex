...
Thus, if researchers using randomized response find that 70\% of participants admit to an illegal activity, the true percentage is actually around 20\% and all database participants are given plausible deniability.
...
Of course, aggregations alone is not sufficient for guaranteeing privacy.
