...
Thus, if researchers using randomized response find that 10\% of participants admit to an illegal activity, the true percentage is actually around 20\% and all database participants are given plausible deniability.
...
PINQ is a privacy layer built over top of the .NET integrated query language, LINQ.
>>>>>>> Make edits according to Chelsea's feedback
