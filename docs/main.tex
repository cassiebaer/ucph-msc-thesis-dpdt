...
A database schema is a list of attributes (or columns).
We represent an \texttt{Attribute} as a pair consisting of its name and type.
A \texttt{Schema} is then just a list of \texttt{Attribute}s.
See Listing~\ref{lst:schemas}.
