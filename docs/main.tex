...
The goal of this thesis is to demonstrate that dependent types are also capable of typing differential privacy metrics with ease and we believe this is certainly the case.
Chapter~\ref{sec:function_sensitivity} showed just how easily metrics such as function sensitivity can be tracked using dependent types.
Chapter~\ref{sec:our_implementation} combined the two into a completely type-safe, PINQ-like EDSL for Idris.
